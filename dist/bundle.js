...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, x, y, 'ted'));
    ...
    _this.cursors = game.input.keyboard.addKeys({
      ...
      'down': _phaser2.default.KeyCode.S,
...
module.exports = __webpack_require__(/*! C:\Users\max\Documents\GitHub\teds-trip\src\main.js */333);
...
var _Level = __webpack_require__(/*! ./states/Level1 */ 343);

var _Level2 = _interopRequireDefault(_Level);

var _Level3 = __webpack_require__(/*! ./states/Level2 */ 344);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'preloadLevelAssets',
    value: function preloadLevelAssets() {
...
var _Ted = __webpack_require__(/*! ../sprites/Ted */ 92);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.game.ted = new _Ted2.default({
        game: this.game,
        x: 32,
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.spaceKey = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.SPACEBAR);
      this.game.ted = new _Ted2.default({
        game: this.game,
        x: 32,
    ...
    key: 'createPlatform',
    value: function createPlatform(x, y, type, number) {
...
var _LevelPrototype2 = __webpack_require__(/*! ./LevelPrototype */ 345);
...
var Level2 = function (_LevelPrototype) {
    _inherits(Level2, _LevelPrototype);
    ...
    _createClass(Level2, [{
        key: 'preload',
        value: function preload() {
            _get(Level2.prototype.__proto__ || Object.getPrototypeOf(Level2.prototype), 'preload', this).call(this);
        }
    }, {
        key: 'create',
        value: function create() {
            _get(Level2.prototype.__proto__ || Object.getPrototypeOf(Level2.prototype), 'create', this).call(this);
        }
    }, {
        key: 'setupPlatforms',
        value: function setupPlatforms() {
            _get(Level2.prototype.__proto__ || Object.getPrototypeOf(Level2.prototype), 'setupPlatforms', this).call(this);
            this.createPlatform(400, this.game.world.height - 600, 'floor2', 3);
            this.createPlatform(2000, this.game.world.height - 1200, 'floor2', 4);
    ...
    return Level2;
}(_LevelPrototype2.LevelPrototype);

/***/ }),
/* 345 */
/*!**************************************!*\
  !*** ./src/states/LevelPrototype.js ***!
  \**************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
exports.LevelPrototype = undefined;
...
var LevelPrototype = exports.LevelPrototype = function (_Phaser$State) {
  _inherits(LevelPrototype, _Phaser$State);

  function LevelPrototype() {
    _classCallCheck(this, LevelPrototype);

    return _possibleConstructorReturn(this, (LevelPrototype.__proto__ || Object.getPrototypeOf(LevelPrototype)).apply(this, arguments));
  }

  _createClass(LevelPrototype, [{
    key: 'init',
    value: function init() {
      //this.stage.backgroundColor = '#F442DF'
      this.background = this.game.add.tileSprite(0, 0, 10000, 3000, 'background');
